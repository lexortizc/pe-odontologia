...
namespace AppOdontologia
{
    public partial class frmAgregarHistoria3 : Form
    {
        ...
        public void insertar() {
            query = "insert into tblHistoria (fecha, motivoConsulta, enfermedad, diagnostico, estado, idPaciente) values ('"+h.fecha+"','"+h.motivo+"','"+h.enfermedad+"','"+h.diagnostico+"','"+h.estado+"',"+ h.idpaciente + ");";
            con.Ejecutar(query);
        }
        #endregion
